...
// MintyMonster generic CharacterController
// Cameron Liddell | github/MintyMonster
public class CharacterControl : MonoBehaviour
{

    public static CharacterControl instance;

    public delegate void PlayerNoiseEvent(Vector3 position);
    public static event PlayerNoiseEvent OnPlayerNoise;
    ...
    {
        OnPlayerNoise?.Invoke(transform.position);
    }
